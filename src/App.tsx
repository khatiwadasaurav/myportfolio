import {Bot, ChevronDown, Code2, Database, ExternalLink, Github, Linkedin, Mail, Smartphone} from 'lucide-react';
import DoodleBackground, {pulseAndFade,} from "./components/libs/doodle-background.tsx";
import {Testimonial, TestimonialsSection} from "./components/Testimonials.tsx";
...
function App() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-50 via-slate-100 to-white text-slate-800">
            ...
            <DoodleBackground rule={pulseAndFade}/>
            {/* Hero Section */}
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-white/80 rounded-lg p-8 shadow-lg backdrop-blur-sm border border-slate-200">
                        <p className="text-lg text-slate-600 mb-6">
                            With over 7 years of experience in software development, I specialize in creating innovative
                            full-stack web applications and mobile solutions. My passion lies in leveraging cutting-edge
                            AI technologies to transform conventional applications into intelligent, interactive
            ...
            <section className="py-20 px-4 bg-gradient-to-b from-slate-100 to-white">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {[1, 2, 3, 4].map((project) => (
                            <div key={project}
                                 className="bg-white rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300 shadow-md hover:shadow-xl">
                                <img
                                ...
                                />
                                <div className="p-6">
                                    <h3 className="text-xl font-semibold mb-2 text-slate-800">AI-Powered Project
                                        Manager</h3>
                                    <p className="text-slate-600 mb-4">An intelligent project management system using AI
                                        agents for task automation and smart notifications.</p>
                                    <div className="flex gap-2">
                                        <span
                                            className="px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-sm">React</span>
                                        <span
                                            className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm">Node.js</span>
                                        <span
                                            className="px-3 py-1 bg-pink-100 text-pink-700 rounded-full text-sm">AI</span>
                                    </div>
                                    <a href="#"
